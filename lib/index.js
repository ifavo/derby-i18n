...
i18n.localize = function(app, options) {
    ...
    function _translate(key, count) {
        var model = this.view.model
          , pluralSuffix = count !== undefined && typeof count === 'number'? i18n.plurals.get(model.get('_i18n.locale'), count): ''
          , translation = o.backend.get(model, model.get('_i18n.locale'), model.get('_i18n.namespace'), key + pluralSuffix)

        return !!pluralSuffix || !!count? util.applyReplacement(translation, { count: count }): translation;
    }
    function _locale() {
